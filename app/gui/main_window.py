...
class MainWindow(QtWidgets.QWidget):
    ...
    def _build_calibration(self):
        sc = self._make_page()
        lay = sc.widget().layout()
        c = self._card("Calibration Wizard")
        c.layout().addWidget(QtWidgets.QLabel("1. Select sensor mouse"))
        c.layout().addWidget(QtWidgets.QLabel("2. Walk slowly 5 sec"))
        c.layout().addWidget(QtWidgets.QLabel("3. Walk normally 5 sec"))
        c.layout().addWidget(QtWidgets.QLabel("4. Run 5 sec"))
        c.layout().addWidget(QtWidgets.QLabel("5. Test joystick output"))
        c.layout().addWidget(QtWidgets.QLabel("6. Save calibration"))
